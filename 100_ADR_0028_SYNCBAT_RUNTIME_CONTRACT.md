...
After retiring the in-workspace Rust `downstream-kit` kit crate, `syncbat` is the
...
vocabulary, ExtProfile, MCP, browser, agent semantics, or native batpak store internals
