...
- `bpk-lib/crates/core/src/store/mod.rs` (`Store::walk_ancestors`, `Store::chain_walk_evidence`)
- `bpk-lib/crates/core/src/store/chain_walk.rs`
- `100_ADR_0019_CANONICAL_ENCODING_CONTRACT.md`
- `100_ADR_0020_SCHEMA_SNAPSHOT_DRIFT_REPORT.md`
