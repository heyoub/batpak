...
pub const REQUIRED_PASS_GATE_NAME: &str = "clawbat.required_pass";
/// Stable batpak gate name for a required capability check.
pub const REQUIRED_CAPABILITY_GATE_NAME: &str = "clawbat.required_capability";
/// Machine-readable denial code for a missing pass.
pub const MISSING_PASS_CODE: &str = "CLAWBAT_MISSING_PASS";
/// Machine-readable denial code for a missing capability.
pub const MISSING_CAPABILITY_CODE: &str = "CLAWBAT_MISSING_CAPABILITY";
...
/// Caller-provided requirement context used by clawbat requirement gates.
///
/// This trait is intentionally read-only. It lets clawbat declarations compile
...
impl<Ctx: GateContext> Gate<Ctx> for RequiredPassGate {
    ...
    fn description(&self) -> &'static str {
        "requires a declared clawbat pass"
    }
}
...
impl<Ctx: GateContext> Gate<Ctx> for RequiredPassSetGate {
    ...
    fn description(&self) -> &'static str {
        "requires declared clawbat passes"
    }
}
...
impl<Ctx: GateContext> Gate<Ctx> for RequiredCapabilityGate {
    ...
    fn description(&self) -> &'static str {
        "requires a declared clawbat capability"
    }
}
...
impl<Ctx: GateContext> Gate<Ctx> for RequiredCapabilitySetGate {
    ...
    fn description(&self) -> &'static str {
        "requires declared clawbat capabilities"
    }
}
