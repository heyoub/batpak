...
use netbat as nb;
use syncbat::{
    EventStreamCursorV1, SessionControl, SessionDelivery, SessionEnd, SessionError,
...
fn event_delivery(
    delivery_index: u64,
    cursor_before: EventStreamCursorV1,
    cursor_after: EventStreamCursorV1,
) -> SessionDelivery {
...
fn watermark_delivery(delivery_index: u64, cursor_after: EventStreamCursorV1) -> SessionDelivery {
...
fn cursor_beginning() -> EventStreamCursorV1 {
    EventStreamCursorV1::beginning(SUBSCRIPTION_ID, CATEGORY)
}

fn cursor_after(global_sequence: u64) -> EventStreamCursorV1 {
